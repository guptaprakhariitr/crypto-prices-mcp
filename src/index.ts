...
function renderLanding(env: Env, url: URL): string {
  ...
  const tagline = env.PRODUCT_TAGLINE ?? "Live + historical cryptocurrency prices via CoinGecko for AI agents.";
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><title>crypto-prices-mcp</title>
